...
# ps.png.its.mangrove <- prune_taxa(taxa_sums(ps.png.its.mangrove) > 0, ps.png.its.mangrove)
psra.png.its.mangrove <- transform_sample_counts(ps.png.its.mangrove, function(otu){otu/sum(otu)})

ps.png.its.seagrass <- subset_samples(ps.png.its, hostTaxa == "Seagrass")
# ps.png.its.seagrass <- prune_taxa(taxa_sums(ps.png.its.seagrass) > 0, ps.png.its.seagrass)
psra.png.its.seagrass <- transform_sample_counts(ps.png.its.seagrass, function(otu){otu/sum(otu)})
...
ps.png.its.ea <- subset_samples(ps.png.its, host == "Enhalus acoroides")
# ps.png.its.ea <- prune_taxa(taxa_sums(ps.png.its.ea) > 0, ps.png.its.ea)
psra.png.its.ea <- transform_sample_counts(ps.png.its.ea, function(otu){otu/sum(otu)})

ps.png.its.th <- subset_samples(ps.png.its, host == "Thalassia hemprichii")
# ps.png.its.th <- prune_taxa(taxa_sums(ps.png.its.th) > 0, ps.png.its.th)
psra.png.its.th <- transform_sample_counts(ps.png.its.th, function(otu){otu/sum(otu)})

ps.png.its.nosediment <- subset_samples(ps.png.its, hostSection != "Sediment")
psra.png.its.nosediment <- transform_sample_counts(ps.png.its.nosediment, function(otu){otu/sum(otu)})
ps.png.its.nosediment
}
...
# Rarefaction Curves
{
  ...
  rarefactionCurve(ps.png.its, "site", COLOR_SITE, filename_tag = "PNG-ITS")
  rarefactionCurve(ps.png.its, "host", COLOR_HOST, filename_tag = "PNG-ITS")
}
...
## Seagrass
ps.png.its.seagrass.top20 <- createTop20ASVPhyloseq(ps.png.its.seagrass)

## By Species
ps.png.its.aa.top20 <- createTop20ASVPhyloseq(ps.png.its.aa)
ps.png.its.sa.top20 <- createTop20ASVPhyloseq(ps.png.its.sa)
ps.png.its.ea.top20 <- createTop20ASVPhyloseq(ps.png.its.ea)
ps.png.its.th.top20 <- createTop20ASVPhyloseq(ps.png.its.th)
...
## Phylum
{### All
  ra_barplot_its_host_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "host", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "General")
  ggsave(ra_barplot_its_host_phylum, filename = "./Outputs/relativeAbundanceBarplot-host-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_site_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "site", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "General")
  ggsave(ra_barplot_its_site_phylum, filename = "./Outputs/relativeAbundanceBarplot-site-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_sample_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "sampleName", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "General")
  ggsave(ra_barplot_its_sample_phylum, filename = "./Outputs/relativeAbundanceBarplot-sample-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ### Seagrass
  ra_barplot_its_seagrass_host_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "host", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_host_phylum, filename = "./Outputs/relativeAbundanceBarplot-seagrass-host-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_site_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "site", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_site_phylum, filename = "./Outputs/relativeAbundanceBarplot-seagrass-site-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_sample_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "sampleName", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_sample_phylum, filename = "./Outputs/relativeAbundanceBarplot-seagrass-sample-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  #### Enhalus acoroides
  ra_barplot_its_ea_site_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "site", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_site_phylum, filename = "./Outputs/relativeAbundanceBarplot-ea-site-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_ea_sample_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "sampleName", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_sample_phylum, filename = "./Outputs/relativeAbundanceBarplot-ea-sample-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  
  #### Thalassia hemprichii
  ra_barplot_its_th_site_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "site", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_site_phylum, filename = "./Outputs/relativeAbundanceBarplot-th-site-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_th_sample_phylum <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "sampleName", fill.variable = "Phylum", color_pal = COLOR_PHYLUM, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_sample_phylum, filename = "./Outputs/relativeAbundanceBarplot-th-sample-phylum-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  }

## Class
{### All
  ra_barplot_its_host_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "host", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "General")
  ggsave(ra_barplot_its_host_class, filename = "./Outputs/relativeAbundanceBarplot-host-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_site_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "site", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "General")
  ggsave(ra_barplot_its_site_class, filename = "./Outputs/relativeAbundanceBarplot-site-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_sample_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "sampleName", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "General")
  ggsave(ra_barplot_its_sample_class, filename = "./Outputs/relativeAbundanceBarplot-sample-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ### Seagrass
  ra_barplot_its_seagrass_host_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "host", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_host_class, filename = "./Outputs/relativeAbundanceBarplot-seagrass-host-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_site_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "site", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_site_class, filename = "./Outputs/relativeAbundanceBarplot-seagrass-site-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_sample_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "sampleName", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_sample_class, filename = "./Outputs/relativeAbundanceBarplot-seagrass-sample-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  #### Enhalus acoroides
  ra_barplot_its_ea_site_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "site", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_site_class, filename = "./Outputs/relativeAbundanceBarplot-ea-site-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_ea_sample_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "sampleName", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_sample_class, filename = "./Outputs/relativeAbundanceBarplot-ea-sample-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  
  #### Thalassia hemprichii
  ra_barplot_its_th_site_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "site", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_site_class, filename = "./Outputs/relativeAbundanceBarplot-th-site-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_th_sample_class <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "sampleName", fill.variable = "Class", color_pal = COLOR_CLASS, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_sample_class, filename = "./Outputs/relativeAbundanceBarplot-th-sample-class-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
}

## Order
{### All
  ra_barplot_its_host_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "host", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "General")
  ggsave(ra_barplot_its_host_order, filename = "./Outputs/relativeAbundanceBarplot-host-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_site_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "site", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "General")
  ggsave(ra_barplot_its_site_order, filename = "./Outputs/relativeAbundanceBarplot-site-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_sample_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "sampleName", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "General")
  ggsave(ra_barplot_its_sample_order, filename = "./Outputs/relativeAbundanceBarplot-sample-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ### Seagrass
  ra_barplot_its_seagrass_host_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "host", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_host_order, filename = "./Outputs/relativeAbundanceBarplot-seagrass-host-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_site_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "site", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_site_order, filename = "./Outputs/relativeAbundanceBarplot-seagrass-site-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_sample_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "sampleName", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_sample_order, filename = "./Outputs/relativeAbundanceBarplot-seagrass-sample-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  #### Enhalus acoroides
  ra_barplot_its_ea_site_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "site", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_site_order, filename = "./Outputs/relativeAbundanceBarplot-ea-site-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_ea_sample_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "sampleName", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_sample_order, filename = "./Outputs/relativeAbundanceBarplot-ea-sample-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  
  #### Thalassia hemprichii
  ra_barplot_its_th_site_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "site", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_site_order, filename = "./Outputs/relativeAbundanceBarplot-th-site-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_th_sample_order <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "sampleName", fill.variable = "Order", color_pal = COLOR_ORDER, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_sample_order, filename = "./Outputs/relativeAbundanceBarplot-th-sample-order-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
}

## Family
{### All
  ra_barplot_its_host_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "host", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "General")
  ggsave(ra_barplot_its_host_family, filename = "./Outputs/relativeAbundanceBarplot-host-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_site_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "site", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "General")
  ggsave(ra_barplot_its_site_family, filename = "./Outputs/relativeAbundanceBarplot-site-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_sample_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "sampleName", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "General")
  ggsave(ra_barplot_its_sample_family, filename = "./Outputs/relativeAbundanceBarplot-sample-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ### Seagrass
  ra_barplot_its_seagrass_host_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "host", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_host_family, filename = "./Outputs/relativeAbundanceBarplot-seagrass-host-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_site_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "site", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_site_family, filename = "./Outputs/relativeAbundanceBarplot-seagrass-site-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_sample_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "sampleName", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_sample_family, filename = "./Outputs/relativeAbundanceBarplot-seagrass-sample-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  #### Enhalus acoroides
  ra_barplot_its_ea_site_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "site", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_site_family, filename = "./Outputs/relativeAbundanceBarplot-ea-site-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_ea_sample_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "sampleName", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_sample_family, filename = "./Outputs/relativeAbundanceBarplot-ea-sample-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  
  #### Thalassia hemprichii
  ra_barplot_its_th_site_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "site", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_site_family, filename = "./Outputs/relativeAbundanceBarplot-th-site-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_th_sample_family <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "sampleName", fill.variable = "Family", color_pal = COLOR_FAMILY, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_sample_family, filename = "./Outputs/relativeAbundanceBarplot-th-sample-family-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
}

## Genus
{### All
  ra_barplot_its_host_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "host", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "General")
  ggsave(ra_barplot_its_host_genus, filename = "./Outputs/relativeAbundanceBarplot-host-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_site_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "site", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "General")
  ggsave(ra_barplot_its_site_genus, filename = "./Outputs/relativeAbundanceBarplot-site-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_sample_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "sampleName", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "General")
  ggsave(ra_barplot_its_sample_genus, filename = "./Outputs/relativeAbundanceBarplot-sample-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ### Seagrass
  ra_barplot_its_seagrass_host_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "host", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_host_genus, filename = "./Outputs/relativeAbundanceBarplot-seagrass-host-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_site_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "site", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_site_genus, filename = "./Outputs/relativeAbundanceBarplot-seagrass-site-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_sample_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "sampleName", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_sample_genus, filename = "./Outputs/relativeAbundanceBarplot-seagrass-sample-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  #### Enhalus acoroides
  ra_barplot_its_ea_site_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "site", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_site_genus, filename = "./Outputs/relativeAbundanceBarplot-ea-site-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_ea_sample_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "sampleName", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_sample_genus, filename = "./Outputs/relativeAbundanceBarplot-ea-sample-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  
  #### Thalassia hemprichii
  ra_barplot_its_th_site_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "site", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_site_genus, filename = "./Outputs/relativeAbundanceBarplot-th-site-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_th_sample_genus <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "sampleName", fill.variable = "Genus", color_pal = COLOR_GENUS, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_sample_genus, filename = "./Outputs/relativeAbundanceBarplot-th-sample-genus-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
}

## Species
{### All
  ra_barplot_its_host_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "host", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "General")
  ggsave(ra_barplot_its_host_species, filename = "./Outputs/relativeAbundanceBarplot-host-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_site_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "site", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "General")
  ggsave(ra_barplot_its_site_species, filename = "./Outputs/relativeAbundanceBarplot-site-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_sample_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.top20, x.variable = "sampleName", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "General")
  ggsave(ra_barplot_its_sample_species, filename = "./Outputs/relativeAbundanceBarplot-sample-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ggsave(ra_barplot_its_mangrove_host_species, filename = "./Outputs/relativeAbundanceBarplot-magrove-host-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  ### Seagrass
  ra_barplot_its_seagrass_host_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "host", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_host_species, filename = "./Outputs/relativeAbundanceBarplot-seagrass-host-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_site_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "site", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_site_species, filename = "./Outputs/relativeAbundanceBarplot-seagrass-site-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_seagrass_sample_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.seagrass.top20, x.variable = "sampleName", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Seagrass")
  ggsave(ra_barplot_its_seagrass_sample_species, filename = "./Outputs/relativeAbundanceBarplot-seagrass-sample-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ...
  #### Enhalus acoroides
  ra_barplot_its_ea_site_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "site", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_site_species, filename = "./Outputs/relativeAbundanceBarplot-ea-site-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_ea_sample_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.ea.top20, x.variable = "sampleName", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Enhalus acoroides")
  ggsave(ra_barplot_its_ea_sample_species, filename = "./Outputs/relativeAbundanceBarplot-ea-sample-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  
  #### Thalassia hemprichii
  ra_barplot_its_th_site_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "site", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_site_species, filename = "./Outputs/relativeAbundanceBarplot-th-site-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
  ra_barplot_its_th_sample_species <- plotRelativeAbundanceBarplot(ps.variable = ps.png.its.th.top20, x.variable = "sampleName", fill.variable = "Species", color_pal = COLOR_SPECIES, title.variable = "Thalassia hemprichii")
  ggsave(ra_barplot_its_th_sample_species, filename = "./Outputs/relativeAbundanceBarplot-th-sample-species-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
}
}
...
diversity <- data.frame(
                  site = psra.png.its@sam_data$site,
                  host = psra.png.its@sam_data$host,
                  hostTaxa = psra.png.its@sam_data$hostTaxa,
                  hostSection = psra.png.its@sam_data$hostSection,
                  shannon = vegan::diversity(otu_table(psra.png.its, taxa_are_rows = FALSE)),
                  richness = t(colSums(decostand(otu_table(psra.png.its, taxa_are_rows = FALSE), method = "pa"))))
write.csv(diversity, file = "./Outputs/diversity-PNG-ITS.csv", quote = FALSE)
diversity
...
ggsave(filename = "./Outputs/shannonDiversity-site-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
...
#   guides(color = NULL) + 
#   scale_fill_manual(values = COLOR_HOST)
# ggsave(filename = "./Outputs/Shannon_Diversity_site-Coral-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
# #ggsave(filename = "./Outputs/Shannon_Diversity_site_Coral-PNG-ITS.pdf", dpi = 300, width = 12, height = 10)
...
ggsave(filename = "./Outputs/shannonDiversity-host-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
...
ggsave(filename = "./Outputs/shannonDiversity-hostTaxa-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
...
ggsave(filename = "./Outputs/shannonDiversity-hostSection-PNG-ITS.svg", dpi = 300, width = 12, height = 10)
}
...
write.csv(as.data.frame(shannon_pairwise_comparions$p.value), "./Outputs/shannonDiversityWilcoxonPairwiseTests-PNG-ITS.csv")
}
...
makeNMDSSimple(ps.variable = ps.png.its.nosediment, label.variable = "PNG excluding Sediment - ITS", file.variable = "PNG_noSediment-ITS")
makeNMDSSingleFull(ps.variable = ps.png.its, label.variable = "PNG - ITS", file.variable = "PNG-ITS")
makeNMDSSingleFull(ps.variable = ps.png.its.nosediment, label.variable = "PNG excluding Sediment - ITS", file.variable = "PNG_noSediment-ITS")
...
# PERMANOVA
ps.png.its.permanova <- subset_taxa(ps.png.its, !is.na(Genus)) # Getting rid off non identified taxa at genus level
ps.png.its.permanova <- prune_samples(sample_sums(ps.png.its.permanova) > 0, ps.png.its.permanova)
ps.png.its.permanova <- prune_taxa(taxa_sums(ps.png.its.permanova) > 0, ps.png.its.permanova)
ps.png.its.permanova <- transform_sample_counts(ps.png.its.permanova, function(otu){otu/sum(otu)})
ps.png.its.permanova <- subset_taxa(ps.png.its.nmds, !is.na(Genus))
otu = as.data.frame(otu_table(ps.png.its.permanova, taxa_are_rows = FALSE))
meta = as.data.frame(sample_data(ps.png.its.permanova))
...
sink("./Outputs/adonis_table-PNG-ITS.txt")
...
core.its <- core_members(ps.png.its, detection = 10/100, prevalence = 20/100)
core.its.noSediment <- core_members(ps.png.its.nosediment, detection = 10/100, prevalence = 20/100)
...
venn_hostSection <- ps_venn(ps.png.its.mangrove, "hostSection", fills = list(fill = COLOR_HOST_SECTION[c("Fruit", "Leaf", "Pneumatophore", "Sediment")], alpha = 0.5))
venn_hostSection
svglite("./Outputs/vennDiagram-hostSection-mangrove-PNG-ITS.svg")
venn_hostSection
dev.off()

venn_host <- ps_venn(ps.png.its.mangrove, "host", fills = list(fill = COLOR_HOST[c("Avicinea alba", "Sonneratia alba")], alpha = 0.5))
venn_host
svglite("./Outputs/vennDiagram-host-mangrove-PNG-ITS.svg")
venn_host
dev.off()

venn_host_noSediment <- ps_venn(ps.png.its.mangrove.nosediment, "host", fills = list(fill = COLOR_HOST[c("Avicinea alba", "Sonneratia alba")], alpha = 0.5))
...
sink("./Outputs/padonis_host_table-Coral-PNG-ITS.txt")
noquote("Pairwise adonis between hosts (Bonferroni corrected Pvalues):")
sink(NULL)
write.table(padonis_host, "./Outputs/padonis_host_table-Coral-PNG-ITS.txt", sep = "\t", quote = FALSE, append = TRUE)

### Site
padonis_site <- pairwise.adonis(otu, as.character(meta$site))
sink("./Outputs/padonis_site_table-Coral-PNG-ITS.txt")
noquote("Pairwise adonis between sites (Bonferroni corrected Pvalues):")
sink(NULL)
write.table(padonis_site, "./Outputs/padonis_site_table-Coral-PNG-ITS.txt", sep = "\t", quote = FALSE, append = TRUE)

#### DH
ps_coral_its_permanova_dh <- subset_taxa(ps_coral_its_nmds_dh, !is.na(Genus))
otu = as.data.frame(otu_table(ps_coral_its_permanova_dh, taxa_are_rows = FALSE))
meta = as.data.frame(sample_data(ps_coral_its_permanova_dh))
...
sink("./Outputs/padonis_site_table-Coral-PNG-ITS.txt", append = TRUE)
print("Pairwise adonis between sites for Diploastrea heliopora (Bonferroni corrected Pvalues):")
sink(NULL)
write.table(padonis_site_dh, "./Outputs/padonis_site_table-Coral-PNG-ITS.txt", sep = "\t", quote = FALSE, append = TRUE)
